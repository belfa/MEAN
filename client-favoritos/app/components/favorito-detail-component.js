...
var FavoritosDetailComponent = (function () {
    function FavoritosDetailComponent(_favoritoService, _route, _router) {
        this._favoritoService = _favoritoService;
        this._route = _route;
        this._router = _router;
    }
    FavoritosDetailComponent.prototype.ngOnInit = function () {
        this.getFavorito();
    };
    FavoritosDetailComponent.prototype.getFavorito = function () {
        var _this = this;
    ...
    return FavoritosDetailComponent;
}());
FavoritosDetailComponent = __decorate([
    core_1.Component({
...
exports.FavoritosDetailComponent = FavoritosDetailComponent;
